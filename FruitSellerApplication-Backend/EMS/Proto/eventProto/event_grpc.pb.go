...
type EventServiceClient interface {
	Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*EventResponse, error)
...
func (c *eventServiceClient) Publish(ctx context.Context, in *PublishRequest, opts ...grpc.CallOption) (*EventResponse, error) {
	out := new(EventResponse)
	err := c.cc.Invoke(ctx, "/eventProto.EventService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (EventService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &EventService_ServiceDesc.Streams[0], "/eventProto.EventService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *eventServiceSubscribeClient) Recv() (*StreamData, error) {
	m := new(StreamData)
...
type EventServiceServer interface {
	Publish(context.Context, *PublishRequest) (*EventResponse, error)
...
func (UnimplementedEventServiceServer) Publish(context.Context, *PublishRequest) (*EventResponse, error) {
...
func _EventService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/eventProto.EventService/Publish",
	}
...
func (x *eventServiceSubscribeServer) Send(m *StreamData) error {
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "eventProto.EventService",
	...
	Metadata: "eventProto/event.proto",
}
